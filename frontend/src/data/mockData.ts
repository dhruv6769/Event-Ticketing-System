export const MOCK_EVENTS = [
  ...
  { id: 16, title: "Kolkata Derby: Mohun Bagan vs East Bengal", category: "Sports", venue: "Salt Lake Stadium", date: "Nov 30, 2026", price: "₹300", image: "/highres/event_kolkata_derby.jpg", badge: "Selling Fast", teams: { home: { name: 'MBSG', form: ['W','W','W'] }, away: { name: 'EBFC', form: ['D','L','W'] } } },
  { id: 17, title: "ISL Match: Kerala Blasters vs Mumbai City", category: "Sports", venue: "Jawaharlal Nehru Stadium (Kochi)", date: "Dec 15, 2026", price: "₹240", image: "/highres/event_kbfc_mcfc.png", badge: "Almost Full", teams: { home: { name: 'KBFC', form: ['W','D','L'] }, away: { name: 'MCFC', form: ['W','W','D'] } } },
  { id: 18, title: "IPL Match: CSK vs RCB", category: "Sports", venue: "M.A. Chidambaram Stadium", date: "April 02, 2027", price: "₹1000", image: "/highres/event_csk_rcb.jpg", badge: "Selling Fast", teams: { home: { name: 'CSK', form: ['W','W','L'] }, away: { name: 'RCB', form: ['L','W','W'] } } }
];
