          ...
          <Link to="/" className="relative group flex-shrink-0">
            ...
            >
              ...
              <svg
                ...
                className="transition-all duration-300 group-hover:scale-105 group-hover:drop-shadow-[0_0_12px_rgba(230,57,70,0.6)] flex-shrink-0"
              >
                <defs>
                  ...
                  <mask id="ticketMask">
                    ...
                    <circle cx="0" cy="18" r="4.5" fill="black" />
                    <circle cx="36" cy="18" r="4.5" fill="black" />
                  </mask>
                </defs>
                <rect width="36" height="36" rx="10" fill="url(#logoGrad)" mask="url(#ticketMask)" />
                <line x1="6" y1="18" x2="30" y2="18" stroke="white" strokeWidth="1" strokeDasharray="2,2" opacity="0.3" />
                <text
                  x="18"
                  y="24.5"
                  fill="white"
